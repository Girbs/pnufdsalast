...
public class Requete implements Serializable {
    ...
    @ManyToOne(targetEntity = fdsa.edu.pnu.Model.Paiement.class, fetch = FetchType.LAZY)
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.LOCK})
    ...
    private fdsa.edu.pnu.Model.Paiement paiement;
    @ManyToOne(targetEntity = fdsa.edu.pnu.Model.TypeRequete.class, fetch = FetchType.LAZY)
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.LOCK})
    ...
    private fdsa.edu.pnu.Model.TypeRequete typeRequete;
    ...
    public fdsa.edu.pnu.Model.TypeRequete getTypeRequete() {
        return typeRequete;
    }

    public void setTypeRequete(fdsa.edu.pnu.Model.TypeRequete value) {
        this.typeRequete = value;
    }

    public fdsa.edu.pnu.Model.Paiement getPaiement() {
        return paiement;
    }

    public void setPaiement(fdsa.edu.pnu.Model.Paiement value) {
        this.paiement = value;
    }
