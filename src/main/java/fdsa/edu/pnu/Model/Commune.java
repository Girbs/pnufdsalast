...
public class Commune implements Serializable {
    ...
    private int id;
    @ManyToOne(targetEntity = fdsa.edu.pnu.Model.DepartementGeographique.class, fetch = FetchType.LAZY)
    ...
    private fdsa.edu.pnu.Model.DepartementGeographique departementGeographique;
    @Column(name = "Description", nullable = true, length = 255)
    private String description;
    @OneToMany(mappedBy = "commune", targetEntity = fdsa.edu.pnu.Model.Personne.class)
    ...
    public fdsa.edu.pnu.Model.DepartementGeographique getDepartementGeographique() {
        return departementGeographique;
    }

    public void setDepartementGeographique(fdsa.edu.pnu.Model.DepartementGeographique value) {
