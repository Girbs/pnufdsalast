...
public class Publication implements Serializable {
    ...
    private int id;
    @ManyToOne(targetEntity = fdsa.edu.pnu.Model.Professeur.class, fetch = FetchType.LAZY)
    ...
    public fdsa.edu.pnu.Model.Professeur getProfesseur() {
        return professeur;
    }

    public void setProfesseur(fdsa.edu.pnu.Model.Professeur value) {
