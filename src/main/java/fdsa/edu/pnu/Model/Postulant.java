...
public class Postulant extends Audit implements Serializable {
    ...
    @OneToMany(mappedBy = "postulant", targetEntity = fdsa.edu.pnu.Model.HistoriqueExamenConcours.class)
