...
//    List<CoursEtudiant> verifierChoixCours(@Param("IdProgrammeCours") Integer IdCoursProgramme );
    ...
    @Query(value = "{call ListeCoursSessionEtudiantByProgramme(:idEtudiant,:idProgramme)}", nativeQuery = true)
    List<CoursEtudiant> ListeCoursSessionEtudiantByProgramme(@Param("idEtudiant") Integer idEtudiant , @Param("idProgramme")Integer idProgramme);
