...
public interface IRoleController {
    ...
    @ApiOperation(value = "Renvoi la liste des Role", notes = "Cette methode permet de chercher et renvoyer la liste des Semestre qui existent "
    ...
    @ApiOperation(value = "Rechercher une Semestre par ID", notes = "Cette methode permet de chercher une Semestre par son ID", response = Role.class)
    @ApiResponses(value = {
