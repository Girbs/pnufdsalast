...
public interface IEvaluationController {
    ...
    @PutMapping(value = "/evaluation/modifier/{id}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "Enregistrer un evaluation", notes = "Cette methode permet d'enregistrer ou modifier un evaluation", response = Evaluation.class)
    @ApiResponses(value = {
    ...
    Evaluation update(@PathVariable("id") Integer id, @RequestBody Evaluation evaluation);
