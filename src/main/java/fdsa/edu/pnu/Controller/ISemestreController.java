...
public interface ISemestreController {
    ...
    @ApiOperation(value = "Renvoi la liste des Semestres", notes = "Cette methode permet de chercher et renvoyer la liste des Session qui existent "
    ...
    @ApiOperation(value = "Supprimer unSemestre", notes = "Cette methode permet de supprimer un Session par ID")
    @ApiResponses(value = {
